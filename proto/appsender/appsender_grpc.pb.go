...
// All implementations should embed UnimplementedAppSenderServer
...
// UnimplementedAppSenderServer should be embedded to have forward compatible implementations.
