...
var file_net_conn_conn_proto_rawDesc = []byte{
	...
	0x64, 0x6b, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x6e, 0x65, 0x74, 0x2f, 0x63, 0x6f, 0x6e,
...
func file_net_conn_conn_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_net_conn_conn_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_net_conn_conn_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_net_conn_conn_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_net_conn_conn_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_net_conn_conn_proto_msgTypes[4].Exporter = func(v any, i int) any {
	...
	file_net_conn_conn_proto_msgTypes[1].OneofWrappers = []any{}
