...
// All implementations should embed UnimplementedBroadcastAPIServer
...
// UnimplementedBroadcastAPIServer should be embedded to have forward compatible implementations.
