...
type ValidatorStateClient interface {
	...
	// GetCurrentValidatorSet returns the validator set for the provided subnets at
...
func (c *validatorStateClient) GetCurrentValidatorSet(ctx context.Context, in *GetCurrentValidatorSetRequest, opts ...grpc.CallOption) (*GetCurrentValidatorSetResponse, error) {
	...
	err := c.cc.Invoke(ctx, ValidatorState_GetCurrentValidatorSet_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// All implementations should embed UnimplementedValidatorStateServer
...
// UnimplementedValidatorStateServer should be embedded to have forward compatible implementations.
