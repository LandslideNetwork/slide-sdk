...
var file_http_http_proto_rawDesc = []byte{
	...
	0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6c, 0x61, 0x6e, 0x64, 0x73,
	0x6c, 0x69, 0x64, 0x65, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x2f, 0x73, 0x6c, 0x69, 0x64,
	0x65, 0x2d, 0x73, 0x64, 0x6b, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x68, 0x74, 0x74, 0x70,
...
func file_http_http_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_http_http_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*URL); i {
			case 0:
				return &v.state
			case 1:
		...
		file_http_http_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_http_http_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_http_http_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_http_http_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_http_http_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_http_http_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_http_http_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_http_http_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_http_http_proto_msgTypes[9].Exporter = func(v any, i int) any {
