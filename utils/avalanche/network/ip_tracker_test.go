...
//	require.Equal(expected.subnets, actual.subnets)
//}
//
...
//	for _, subnets := range tracker.subnets {
...
//				}
//				tracker.subnets[constants.PrimaryNetworkID] = &gossipableSubnet{
...
//				}
//				tracker.subnets[subnetID] = &gossipableSubnet{
//					numGossipableIPs:   tracker.numGossipableIPs,
//					manuallyGossipable: set.Of(ip.NodeID),
//					gossipableIDs:      set.Of(ip.NodeID),
//					gossipableIndices:  make(map[ids.NodeID]int),
...
//			expectedChange: func(tracker *ipTracker) {
//				tracker.tracked[ip.NodeID].manuallyTracked = true
//				tracker.subnets[constants.PrimaryNetworkID].manuallyGossipable = set.Of(ip.NodeID)
//			},
//		},
//		{
//			name: "non-connected untracked validator",
...
//			subnetID: subnetID,
//			expectedChange: func(tracker *ipTracker) {
//				tracker.subnets[subnetID].manuallyGossipable = set.Of(ip.NodeID)
//			},
//		},
//		{
//			name: "connected tracked validator",
...
//				tracker.tracked[newerIP.NodeID].ip = newerIP
//				tracker.bloomAdditions[newerIP.NodeID] = 2
//				tracker.subnets[constants.PrimaryNetworkID].gossipableIPs[0] = newerIP
//			},
//		},
//		{
...
//		},
//		{
//			name: "first known IP of node tracking subnets",
//			initialState: func(t *testing.T) *ipTracker {
//				tracker := newTestIPTracker(t)
//				tracker.OnValidatorAdded(constants.PrimaryNetworkID, ip.NodeID, nil, ids.Empty, 0)
//				return tracker
...
//				}
//
//				subnets := tracker.subnets[constants.PrimaryNetworkID]
//				subnets.gossipableIndices[ip.NodeID] = 0
//				subnets.gossipableIPs = []*ips.ClaimedIPPort{
//					ip,
//				}
//			},
//		},
//		{
//			name: "first known IP of node not tracking subnets",
//			initialState: func(t *testing.T) *ipTracker {
//				tracker := newTestIPTracker(t)
//				tracker.OnValidatorAdded(subnetID, ip.NodeID, nil, ids.Empty, 0)
//				return tracker
...
//		},
//		{
//			name: "connected with older IP of node tracking subnets",
//			initialState: func(t *testing.T) *ipTracker {
//				tracker := newTestIPTracker(t)
//				tracker.OnValidatorAdded(constants.PrimaryNetworkID, ip.NodeID, nil, ids.Empty, 0)
//				require.True(t, tracker.AddIP(newerIP))
...
//
//				subnets := tracker.subnets[constants.PrimaryNetworkID]
//				subnets.gossipableIndices[newerIP.NodeID] = 0
//				subnets.gossipableIPs = []*ips.ClaimedIPPort{
//					newerIP,
//				}
//			},
//		},
//		{
//			name: "connected with older IP of node not tracking subnets",
//			initialState: func(t *testing.T) *ipTracker {
//				tracker := newTestIPTracker(t)
//				tracker.OnValidatorAdded(subnetID, ip.NodeID, nil, ids.Empty, 0)
//				require.False(t, tracker.AddIP(newerIP))
...
//		},
//		{
//			name: "connected with newer IP of node tracking subnets",
//			initialState: func(t *testing.T) *ipTracker {
//				tracker := newTestIPTracker(t)
//				tracker.OnValidatorAdded(constants.PrimaryNetworkID, ip.NodeID, nil, ids.Empty, 0)
//				require.True(t, tracker.AddIP(ip))
...
//		},
//		{
//			name: "connected with newer IP of node not tracking subnets",
//			initialState: func(t *testing.T) *ipTracker {
//				tracker := newTestIPTracker(t)
//				tracker.OnValidatorAdded(subnetID, ip.NodeID, nil, ids.Empty, 0)
//				require.False(t, tracker.AddIP(ip))
...
//		},
//		{
//			name: "connected with same IP of node tracking subnets",
//			initialState: func(t *testing.T) *ipTracker {
//				tracker := newTestIPTracker(t)
//				tracker.OnValidatorAdded(constants.PrimaryNetworkID, ip.NodeID, nil, ids.Empty, 0)
//				require.True(t, tracker.AddIP(ip))
...
//		},
//		{
//			name: "connected with same IP of node not tracking subnets",
//			initialState: func(t *testing.T) *ipTracker {
//				tracker := newTestIPTracker(t)
//				tracker.OnValidatorAdded(subnetID, ip.NodeID, nil, ids.Empty, 0)
//				require.False(t, tracker.AddIP(ip))
...
//
//				subnets := tracker.subnets[constants.PrimaryNetworkID]
//				delete(subnets.gossipableIndices, ip.NodeID)
//				subnets.gossipableIPs = subnets.gossipableIPs[:0]
//			},
//		},
//		{
...
//
//				subnets := tracker.subnets[constants.PrimaryNetworkID]
//				subnets.gossipableIndices = map[ids.NodeID]int{
//					otherIP.NodeID: 0,
//				}
//				subnets.gossipableIPs = []*ips.ClaimedIPPort{
//					otherIP,
...
//		},
//		{
//			name: "connected to other subnets",
//			initialState: func(t *testing.T) *ipTracker {
//				tracker := newTestIPTracker(t)
//				tracker.Connected(ip, set.Of(constants.PrimaryNetworkID))
//				return tracker
...
//	}{
//		{
//			name: "remove last validator of subnets",
//			initialState: func(t *testing.T) *ipTracker {
//				tracker := newTestIPTracker(t)
//				tracker.OnValidatorAdded(constants.PrimaryNetworkID, ip.NodeID, nil, ids.Empty, 0)
//				return tracker
...
//				delete(tracker.subnets, constants.PrimaryNetworkID)
//			},
//		},
//		{
...
//		},
//		{
//			name: "manually gossiped on other subnets",
//			initialState: func(t *testing.T) *ipTracker {
//				tracker := newTestIPTracker(t)
//				tracker.ManuallyGossip(constants.PrimaryNetworkID, ip.NodeID)
//				tracker.OnValidatorAdded(subnetID, ip.NodeID, nil, ids.Empty, 0)
...
//				delete(tracker.subnets, subnetID)
//			},
//		},
//		{
//			name: "non-latest gossipable",
...
//
//				subnets := tracker.subnets[constants.PrimaryNetworkID]
//				subnets.gossipableIDs.Remove(ip.NodeID)
//				subnets.gossipableIndices = map[ids.NodeID]int{
//					otherIP.NodeID: 0,
//				}
//				subnets.gossipableIPs = []*ips.ClaimedIPPort{
