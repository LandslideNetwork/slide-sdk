...
func NewNetwork(p2pNetwork *p2p.Network, appSender common.AppSender, log log.Logger, maxActiveAppRequests int64,

// codec codec.Manager, self ids.NodeID, maxActiveAppRequests int64
) Network {
	return &network{
		log:       log,
		appSender: appSender,
